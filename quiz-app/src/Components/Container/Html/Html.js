...
class Html extends Component {
  constructor(props){
    ...
    this.state={
      selectedQuiz : '',
      startQuiz:null,
      quiz1Givenbefore:localStorage.getItem("html quiz 1")==="done"?true:false,
      quiz2Givenbefore:localStorage.getItem("html quiz 2")==="done"?true:false,
      currentQuiz1:this.props.htmlQuiz1,
      currentQuiz2:this.props.htmlQuiz2,
    }
  }
  render() {
  ...
  return (
      <div>
        ...
        <h1 style={{display:'inline'}} onClick={()=> this.setState({selectedQuiz:'',startQuiz:null})}>HTML Quizzes</h1>
