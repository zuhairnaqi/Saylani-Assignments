...
class Quiz_2 extends Component {
  ...
  checkKey() {
    ...
    (key === '123456' ?
    (localStorage.setItem('html quiz2 qu',1),this.setState({ checkKey: true })) :
    ...
    return (
      <div>
        ...
        <strong>{questionNum<=5 && <Count_Down minute={8} timeEnd={this.timeEnd}/>}</strong>
          <ol>
            {questionNum === 1 && <li value='1'>What is the correct HTML element for inserting a line break? <br /><br />
            ...
            {questionNum === 2 && <li value='2'>What is the correct HTML for adding a background color? <br /><br />
            ...
            {questionNum === 3 && <li value='3'>Choose the correct HTML element to define emphasized text <br /><br />
            ...
            {questionNum === 4 && <li value='4'>What is the correct HTML for creating a hyperlink? <br /><br />
