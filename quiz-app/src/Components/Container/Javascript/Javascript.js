...
class Javascript extends Component {
  constructor(props){
    ...
    this.state={
      selectedQuiz : '',
      startQuiz:null,
      quiz1Givenbefore:localStorage.getItem("javascript quiz 1")==="done"?true:false,
      quiz2Givenbefore:localStorage.getItem("javascript quiz 2")==="done"?true:false,
      currentQuiz1:this.props.javascriptQuiz1,
      currentQuiz2:this.props.javascriptQuiz2,
    }
  }
  render() {
  ...
  return (
      <div>
        ...
        <h1 style={{display:'inline'}} onClick={()=> this.setState({selectedQuiz:'',startQuiz:null})}>Javascript Quizzes</h1>
