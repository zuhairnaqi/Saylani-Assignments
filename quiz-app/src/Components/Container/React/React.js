...
class Apna_React extends Component {
  constructor(props){
    super(props);
    this.state={
      selectedQuiz : '',
      startQuiz:null,
      quiz1Givenbefore:localStorage.getItem("react quiz 1")==="done"?true:false,
      quiz2Givenbefore:localStorage.getItem("react quiz 2")==="done"?true:false,
      currentQuiz1:this.props.reactQuiz1,
      currentQuiz2:this.props.reactQuiz2,
    }
  }
  render() {
  ...
  return (
      <div>
        ...
        <h1 style={{display:'inline'}} onClick={()=> this.setState({selectedQuiz:'',startQuiz:null})}>react Quizzes</h1>
